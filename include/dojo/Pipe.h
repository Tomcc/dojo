...
//Slightly changed with renames by Tommaso Checchi
//license not included; check 
...
namespace Dojo {
	...
	public:
		...
		AE_FORCEINLINE bool tryQueue(T const& element)
		{
		...
		// Returns true if the element was enqueued, false otherwise.
		// Does not allocate memory.
		AE_FORCEINLINE bool tryQueue(T&& element)
		{
		...
		AE_FORCEINLINE void queue(T const& element)
		{
		...
		// Allocates an additional block of memory if needed.
		AE_FORCEINLINE void queue(T&& element)
		{
	...
	private:
		...
		bool inner_enqueue(U&& element)
		{
			...
			if (nextBlockTail != blockFront) {
				...
				assert(tailBlockNext->front.load() == nextBlockTail);
